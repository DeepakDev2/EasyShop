    ...
    <div className="min-h-screen flex" style={{ background: 'linear-gradient(135deg, #2874f0 0%, #1a5dc9 50%, #f1f3f6 50%)' }}>
      ...
      <div className="hidden md:flex flex-col justify-center px-16 w-2/5 text-white">
        ...
        <div className="mt-8 space-y-3 text-blue-100 text-sm">
          <div className="flex items-center gap-2">✦ Exclusive deals & offers</div>
          <div className="flex items-center gap-2">✦ Track orders easily</div>
          <div className="flex items-center gap-2">✦ Faster checkout every time</div>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                type={showPw ? 'text' : 'password'} required placeholder="Password" minLength={6}
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-500">
              New to EasyShop?{' '}
              <Link href="/auth/register" className="text-[#2874f0] font-semibold hover:underline">
                Create an account
              </Link>
            </p>
          </div>
